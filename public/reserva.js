document.addEventListener("DOMContentLoaded", function () {
    ...
    // Confirmación del método de pago Perú
    ...
    // Confirmación del método de pago España
    ...
    // Validación de comprobante y términos
    ...
    // Confirmar y enviar a Google Sheets
    confirmar.addEventListener("click", () => {
      ...
      // Combinamos código y número como texto
      const codigo = document.getElementById("codigo-pais").value;
      const telefono = document.getElementById("telefono").value;
      formData.append("telefono", `${codigo} ${telefono}`);
  
      fetch("https://script.google.com/macros/s/AKfycbxZeUM6VbGLjfIMOjwb6bd8wt4p_1tcT3UqNwnOiJ5zIFulbH2QU0Ba6J7Mytb2nVht/exec", {
        method: "POST",
        body: formData
      })
        .then(res => res.text())
